...
\begin{frame}{Mass 226}	
	\centering
	\vspace{-0.05\textheight}
	\hspace*{-0.05\textwidth}\includegraphics[width=1.1\textwidth]{AvsG_10us.png}
\end{frame}
...
\begin{frame}{Mass 226}	
	\centering
	\vspace{-0.05\textheight}
	\only<1>{\hspace*{-0.05\textwidth}\includegraphics[width=1.1\textwidth]{AvsG_2us.png}}%
	\only<2>{\hspace*{-0.05\textwidth}\includegraphics[width=1.1\textwidth]{AvsG_2us_226PaGate.png}}%
\end{frame}

\begin{frame}{$^{226}$Pa Gamma spectrum}	
	\centering
	\vspace{-0.05\textheight}
	\only<1>{\includegraphics[width=1\textwidth]{GSpectra_226Pa_badCal.pdf}}%
	\only<2>{\includegraphics[width=1\textwidth]{GSpectra_226Pa_badCal_singleBEGE.pdf}}%
\end{frame}

\begin{frame}{$^{226}$Th Gamma spectrum}	
	\centering
	\vspace{-0.05\textheight}
	\only<1>{\includegraphics[width=\textwidth]{GSpectra_226Th_badCal_singleBEGE.pdf}}%
\end{frame}
...
\begin{frame}{$^{226}$Pa $\alpha\gamma$ coincidence}	
	\centering
	\vspace{-0.05\textheight}
	\hspace*{-0.05\textwidth}\includegraphics[width=1.1\textwidth]{ASpectra_226Pa_GammaGated.pdf}%
\end{frame}
...
\begin{frame}{$^{226}$Th electrons?}	
	\centering
	\vspace{-0.05\textheight}
	\hspace*{-0.05\textwidth}\includegraphics[width=1.1\textwidth]{ESpectra_226Th.pdf}
\end{frame}
