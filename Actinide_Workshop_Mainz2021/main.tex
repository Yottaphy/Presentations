...
\begin{frame}{Production yields}
	...
	\end{textblock*}
		\begin{textblock*}{0.6\paperwidth}(0.02\paperwidth,0.7\paperheight)
			\begin{itemize}
		...
		\end{textblock*}
		\begin{textblock*}{0.5\paperwidth}(0.5\paperwidth,0.7\paperheight)
			\begin{itemize}
...
\begin{frame}{$^{226}$Pa}
	\begin{textblock*}{0.43\paperwidth}(0.01\paperwidth,0.17\paperheight)
